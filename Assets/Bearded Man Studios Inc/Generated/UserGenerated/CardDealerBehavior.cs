...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class CardDealerBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (CardDealerNetworkObject)obj;
		...
		{
			Initialize(new CardDealerNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new CardDealerNetworkObject(networker, this, createCode, metadata);
		}
