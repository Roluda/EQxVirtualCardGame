...
public class SnapshotCamera : MonoBehaviour {
    ...
    #if UNITY_EDITOR
    public static SnapshotCamera MakeSnapshotCameraFromSceneView(string layer, string name = "Snapshot Camera") {
        return MakeSnapshotCameraFromSceneView(LayerMask.NameToLayer(layer), name);
    }

    public static SnapshotCamera MakeSnapshotCameraFromSceneView(int layer = 5, string name = "Snapshot Camera") {
        if (layer < 0 || layer > 31)
            throw new ArgumentOutOfRangeException("layer", "layer argument must specify a valid layer between 0 and 31");
        ...
        // Add a SnapshotCamera component to the GameObject
        SnapshotCamera snapshotCamera = cam.gameObject.AddComponent<SnapshotCamera>();
